...
class Cluster {
    ...
    public constructor() {
        ...
        console.log = (str: any) => process.send({ name: "log", msg: this.logOverride(str) });
        console.error = (str: any) => process.send({ name: "error", msg: this.logOverride(str) });
        console.warn = (str: any) => process.send({ name: "warn", msg: this.logOverride(str) });
        console.info = (str: any) => process.send({ name: "info", msg: this.logOverride(str) });
        console.debug = (str: any) => process.send({ name: "debug", msg: this.logOverride(str) });
    ...
    public connect(firstShardID: number, lastShardID: number, maxShards: number, token: any, type: any, clientOptions: any) {
        ...
        client.on("shardDisconnect", (err: any, id: any) => {
    ...
    public async loadCode(client: any) {
        this.app = new Polls({ client: client, clusterID: this.clusterID });
        this.app.launch();
