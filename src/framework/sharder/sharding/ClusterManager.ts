...
import Eris from "jean-wrapper";
import cluster from "./Cluster";
import logger from '../../utilities/Logger';
import Queue from "../../utilities/Queue";

const clientName = "Polls";
...
export default class ClusterManager extends EventEmitter {
    ...
    public executeStats(clusters: any, start: number) {
    ...
    public chunk(shards: any, clusterCount: number) {
    ...
    public broadcast(start: any, message: any) {
        let cluster = this.clusters.get(start);
        if (cluster) {
    ...
    public sendTo(cluster: any, message: any) {
