...
class Pagination {
    ...
    protected page: any;
    protected embeds: Array<any>;
    protected firstEmbedID: number;
    protected reactions: any;

    protected id;

    public constructor(message: any, embeds: Array<any>, firstEmbedID: number) {
    ...
    public async render(): Promise<void> {
        ...
        const reactionViewer = new continuousListener(renderMessage , (userID: string | number) => userID === this.message.author.id, false, { maxMatches: 250, time: 60000, passedReactions: this.reactions });
